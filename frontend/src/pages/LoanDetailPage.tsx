...
export function LoanDetailPage() {
  ...
  if (!loan) return <div className="text-center py-8 text-gray-500">Loan not found</div>;
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="mt-4">
          <div className="flex justify-between text-xs text-gray-400 mb-1">
            ...
            <span>{formatINR(loan.outstanding_principal)} remaining</span>
          </div>
      ...
      {amortization?.schedule && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-4 border-b border-gray-100">
            ...
            <p className="text-sm text-gray-500">Total interest: {formatINR(amortization.total_interest)}</p>
          </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 sticky top-0">
                <tr>
                  ...
                  <th className="text-right px-4 py-2 text-gray-500 font-medium">EMI</th>
                  <th className="text-right px-4 py-2 text-gray-500 font-medium">Principal</th>
                  <th className="text-right px-4 py-2 text-gray-500 font-medium">Interest</th>
